...
(function () {
  ...
  JSA.PATTERNS = {
    ...
    'frameworks': {
      regex: /(?:React(?:DOM)?\.(?:render|createElement|Component)|angular\.(?:module|component|service)|Vue\.(?:component|use|mixin)|Ember\.(?:Component|Route)|Backbone\.(?:Model|View)|jQuery|__webpack_require__|__NEXT_DATA__|gatsby)/gi,
      label: 'Framework/Library',
      resultCategory: 'libraries',
      severity: 'info',
      confidence: 'high',
      enabled: true
    },
